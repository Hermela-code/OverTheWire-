...
The challenge page provides all the connection information, as shown in the screenshots:
...
ssh bandit0@bandit.labs.overthewire.org -p 2220 ```  
 After running the command, the terminal prompts for a password and you will enter **bandit0**
